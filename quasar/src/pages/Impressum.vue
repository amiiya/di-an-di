<template>
  <div class="q-pa-md row justify-center" ref="impressum">
    <div class="q-gutter-md" style="max-width: 550px">
      <div class="text-center">
        <div class="text-h2">Impressum</div>
        <p class="text-caption text-center">Informationspflicht laut § 5 TMG.</p>
        <p>Di An Di<br />Bachstraße 145, <br />22083 Hamburg, <br />Deutschland</p>
        <p>
          <strong>Tel.:</strong> 040 75684451 <br />
          <strong>E-Mail:</strong> <a href="mailto:info@di-an-di.de">info@di-an-di.de</a>
        </p>
      </div>
      <q-list>
        <q-expansion-item label="EU-Streitschlichtung" expand-separator switch-toggle-side>
          <q-card>
            <q-card-section>
            ...
            Verbraucher haben die Möglichkeit, Beschwerden an die Online Streitbeilegungsplattform der Europäischen Kommission unter <a>http://ec.europa.eu/odr?tid=321135436</a> zu richten. Die dafür notwendigen Kontaktdaten finden Sie oberhalb in unserem Impressum.</p>
            <p>Wir möchten Sie jedoch darauf hinweisen, dass wir nicht bereit oder verpflichtet sind, an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen.</p>
            </q-card-section>
          </q-card>
        </q-expansion-item>
        <q-expansion-item label="Haftung für Inhalte dieser Website" expand-separator switch-toggle-side>
          <q-card>
            <q-card-section>
              <p>Wir entwickeln die Inhalte dieser Webseite ständig weiter und bemühen uns korrekte und aktuelle Informationen bereitzustellen. Laut Telemediengesetz <a>(TMG) §7 (1)</a> sind wir als Diensteanbieter für eigene Informationen, die wir zur Nutzung bereitstellen, nach den allgemeinen Gesetzen verantwortlich. Leider können wir keine Haftung für die Korrektheit aller Inhalte auf dieser Webseite übernehmen, speziell für jene die seitens Dritter bereitgestellt wurden. Als Diensteanbieter im Sinne der §§ 8 bis 10 sind wir nicht verpflichtet, die von ihnen übermittelten oder gespeicherten Informationen zu überwachen oder nach Umständen zu forschen, die auf eine rechtswidrige Tätigkeit hinweisen.</p>
        ...
        <q-expansion-item label="Haftung für Links auf dieser Website" expand-separator switch-toggle-side>
          <q-card>
            <q-card-section>
        ...
        <q-expansion-item label="Urheberrechtshinweis" expand-separator switch-toggle-side>
          <q-card>
            <q-card-section>
        ...
        <q-expansion-item label="Bildernachweis" expand-separator switch-toggle-side>
          <q-card>
            <q-card-section>
              ...
              <ul>
                <li>Di An Di</li>
                <li>
                  <a href="https://www.instagram.com/brotherside/" target="_blank">@brotherside</a>
                </li>
              </ul>
            </q-card-section>
          </q-card>
      ...
      <div class="text-h3 text-center">Datenschutzerklärung</div>
      <q-list>
        <q-expansion-item label="Datenschutz" expand-separator switch-toggle-side>
          <q-card>
            <q-card-section>
              <p>Wir haben diese Datenschutzerklärung (Fassung 12.12.2019-321135436) verfasst, um Ihnen gemäß der Vorgaben der <a>Datenschutz-Grundverordnung (EU) 2016/679</a> zu erklären, welche Informationen wir sammeln, wie wir Daten verwenden und welche Entscheidungsmöglichkeiten Sie als Besucher dieser Webseite haben.</p>
              <p>Leider liegt es in der Natur der Sache, dass diese Erklärungen sehr technisch klingen, wir haben uns bei der Erstellung jedoch bemüht die wichtigsten Dinge so einfach und klar wie möglich zu beschreiben.</p>
            </q-card-section>
          </q-card>
        </q-expansion-item>
        <q-expansion-item label="Automatische Datenspeicherung" expand-separator switch-toggle-side>
          <q-card>
            <q-card-section>
              ...
              Die Rechtsgrundlage besteht nach <a>Artikel 6  Absatz 1 f DSGVO</a> (Rechtmäßigkeit der Verarbeitung) darin, dass berechtigtes Interesse daran besteht, den fehlerfreien Betrieb dieser Webseite durch das Erfassen von Webserver-Logfiles zu ermöglichen.</p>
            </q-card-section>
          </q-card>
        </q-expansion-item>
        <q-expansion-item label="Rechte laut Datenschutzgrundverordnung" expand-separator switch-toggle-side>
          <q-card>
            <q-card-section>
              ...
              <p>Wenn Sie glauben, dass die Verarbeitung Ihrer Daten gegen das Datenschutzrecht verstößt oder Ihre datenschutzrechtlichen Ansprüche sonst in einer Weise verletzt worden sind, können Sie sich an die <a>Bundesbeauftragte für den Datenschutz und die Informationsfreiheit (BfDI)</a> wenden.</p>
            </q-card-section>
          </q-card>
        </q-expansion-item>
        <q-expansion-item label="TLS-Verschlüsselung mit https" expand-separator switch-toggle-side>
          <q-card>
            <q-card-section>
              <p>Wir verwenden https um Daten abhörsicher im Internet zu übertragen (Datenschutz durch Technikgestaltung <a>Artikel 25 Absatz 1 DSGVO</a>). Durch den Einsatz von TLS (Transport Layer Security), einem Verschlüsselungsprotokoll zur sicheren Datenübertragung im Internet können wir den Schutz vertraulicher Daten sicherstellen. Sie erkennen die Benutzung dieser Absicherung der Datenübertragung am kleinen Schloßsymbol links oben im Browser und der Verwendung des Schemas https (anstatt http) als Teil unserer Internetadresse.</p>
            </q-card-section>
          </q-card>
        </q-expansion-item>
        <q-expansion-item label="Google Fonts Datenschutzerklärung" expand-separator switch-toggle-side>
          <q-card>
            <q-card-section>
              ...
              <div class="text-h5">Was sind Google Fonts?</div>
              <p>Google Fonts (früher Google Web Fonts) ist ein interaktives Verzeichnis mit mehr als 800 Schriftarten, die die <a>Google LLC</a> zur freien Verwendung bereitstellt.</p>
              ...
              <div class="text-h5">Warum verwenden wir Google Fonts auf unserer Webseite?</div>
              ...
              <div class="text-h5">Welche Daten werden von Google gespeichert?</div>
              ...
              <div class="text-h5">Wie lange und wo werden die Daten gespeichert?</div>
              ...
              <div class="text-h5">Wie kann ich meine Daten löschen bzw. die Datenspeicherung verhindern?</div>
              <p>Jene Daten, die Google für einen Tag bzw. ein Jahr speichert können nicht einfach gelöscht werden. Die Daten werden beim Seitenaufruf automatisch an Google übermittelt. Um diese Daten vorzeitig löschen zu können, müssen Sie den Google-Support auf <a>https://support.google.com/?hl=de&amp;tid=321135436</a> kontaktieren. Datenspeicherung verhindern Sie in diesem Fall nur, wenn Sie unsere Seite nicht besuchen.</p>
              <p>Anders als andere Web-Schriften erlaubt uns Google uneingeschränkten Zugriff auf alle Schriftarten. Wir können also unlimitiert auf ein Meer an Schriftarten zugreifen und so das Optimum für unsere Webseite rausholen. Mehr zu Google Fonts und weiteren Fragen finden Sie auf <a>https://developers.google.com/fonts/faq?tid=321135436</a>. Dort geht zwar Google auf datenschutzrelevante Angelegenheiten ein, doch wirklich detaillierte Informationen über Datenspeicherung sind nicht enthalten. Es ist relativ schwierig (beinahe unmöglich), von Google wirklich präzise Informationen über gespeicherten Daten zu bekommen.</p>
              <p>Welche Daten grundsätzlich von Google erfasst werden und wofür diese Daten verwendet werden, können Sie auch auf <a>https://www.google.com/intl/de/policies/privacy/</a> nachlesen.</p>
            </q-card-section>
          </q-card>
        </q-expansion-item>
        <q-expansion-item label="Google Maps Datenschutzerklärung" expand-separator switch-toggle-side>
          <q-card>
            <q-card-section>
              ...
              <div class="text-h5">Was ist Google Maps?</div>
              ...
              <div class="text-h5">Warum verwenden wir Google Maps auf unserer Website?</div>
              ...
              <div class="text-h5">Welche Daten werden von Google Maps gespeichert?</div>
              ...
              <p>
              <a>Chrome: Cookies in Chrome löschen, aktivieren und verwalten</a>
              </p>
              <p>
              <a>Safari: Verwalten von Cookies und Websitedaten mit Safari</a>
              </p>
              <p>
              <a>Firefox: Cookies löschen, um Daten zu entfernen, die Websites auf Ihrem Computer abgelegt haben</a>
              </p>
              <p>
              <a>Internet Explorer: Löschen und Verwalten von Cookies</a>
              </p>
              <p>
              <a>Microsoft Edge: Löschen und Verwalten von Cookies</a>
              </p>
              <p>Falls Sie grundsätzlich keine Cookies haben wollen, können Sie Ihren Browser so einrichten, dass er Sie immer informiert, wenn ein Cookie gesetzt werden soll. So können Sie bei jedem einzelnen Cookie entscheiden, ob Sie es erlauben oder nicht.</p>
              <p>Google ist aktiver Teilnehmer beim EU-U.S. Privacy Shield Framework, wodurch der korrekte und sichere Datentransfer persönlicher Daten geregelt wird. Mehr Informationen dazu finden Sie auf <a>https://policies.google.com/privacy?hl=de</a>.</p>
            </q-card-section>
          </q-card>
        </q-expansion-item>
      </q-list>
      <q-card flat>
        <q-card-section>
          Quelle: Erstellt mit dem <a title="Datenschutz Generator Deutschland" href="https://www.adsimple.de/datenschutz-generator/" target="_blank" rel="follow" style="text-decoration:none;">Datenschutz Generator</a> von AdSimple in Kooperation mit <a href="https://www.justmed.de" target="_blank" rel="follow" title="">justmed.de</a>
        </q-card-section>
      </q-card>
    </div>
  </div>
...
export default {
  ...
  mounted () {
    this.scrollToElement(this.$refs.impressum)
  }
}
</script>
